...
export const defaultContent: SiteContent = {
  ...
  activitiesSection: {
    ...
    subtitle: "Art, sports, music, and hands-on learning beyond the classroom",
  },
  activities: [
    {
      id: "1",
      title: "Creative Art & Craft",
      description: "Students explore colors, shapes, and imagination through painting, collage, and seasonal craft projects.",
      body: "Art and craft sessions are among the most loved parts of our week. Children experiment with watercolors, crayons, paper craft, and recycled materials while learning to express ideas in their own way.\n\nEach month follows a cheerful theme — festivals, seasons, nature, and community helpers — so every child takes home something they are proud to show their family.\n\nOur teachers guide students step by step while encouraging creativity and confidence. Finished work is often displayed in classrooms and corridors, celebrating every child's effort and joy in learning.",
      imageUrl: images.schoolActivity,
    ...
    },
    {
      ...
      description: "Fun games and physical activities that build teamwork, coordination, and healthy habits.",
      imageUrl: images.schoolStudents,
      alt: "Students playing outdoors",
      category: "Sports",
      dateLabel: "Regular Sessions",
      featured: true,
    },
    {
      id: "3",
      title: "Music, Dance & Rhythm",
      description: "Rhythm, movement, and expression help children build confidence and celebrate culture.",
      imageUrl: images.schoolBuilding,
      alt: "School activity space",
      category: "Music & Dance",
      dateLabel: "Special Classes",
      featured: true,
    },
    {
      id: "4",
      title: "Science & Discovery",
      description: "Simple experiments and curious questions make learning exciting — from nature walks to classroom demos.",
      imageUrl: images.schoolActivity,
      alt: "Hands-on science learning",
      category: "Science & Discovery",
      dateLabel: "Monthly Themes",
      featured: false,
    },
    {
      id: "5",
      title: "Festivals & Celebrations",
      description: "Students learn about traditions, perform on stage, and share joy during school celebrations.",
      imageUrl: images.schoolStudents,
      alt: "Students at a school celebration",
      category: "Celebrations",
      dateLabel: "Through the Year",
      featured: false,
    },
    {
      id: "6",
      title: "Story Time & Reading Club",
      description: "Books, storytelling, and library time nurture language skills and a lifelong love of reading.",
      imageUrl: images.schoolBuilding,
      alt: "Reading and library activity",
